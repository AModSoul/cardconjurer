...
var masks = [{src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/extended/masks/maskPinlines.png', name:'Pinlines'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/extended/masks/maskFrame.png', name:'Frame'}, {src:'/img/frames/custom/stoneCutter/masks/maskRules.png', name:'Rules Text'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/extended/masks/maskFloating.png', name:'Floating Frame'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/extended/masks/maskBorder.png', name:'Border'}];
...
availableFrames = [
	...
	{name:'Legend Crown Bottom Frame Cover', src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/extended/lowerBar.png', bounds:bounds, erase:true}
];
