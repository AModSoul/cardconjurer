...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadTextOptions({
		...
		ability0: {name:'Ability 1', text:'', x:0.2334, y:0.2150, width:0.35, height:0.1786, size:0.0305},
		ability1: {name:'Ability 2', text:'', x:0.2334, y:0, width:0.35, height:0.1786, size:0.0305},
		ability2: {name:'Ability 3', text:'', x:0.2334, y:0, width:0.35, height:0.1786, size:0.0305},
		ability3: {name:'Ability 4', text:'', x:0.2334, y:0, width:0.35, height:0, size:0.0305},
