...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	autoFitArt();
	//set symbol bounds
	card.setSymbolBounds = {x:0.9213, y:0.6275, width:0.12, height:0.0410, vertical:'center', horizontal: 'right'};
	resetSetSymbol();
	//watermark bounds
	...
	//text
	loadTextOptions({
		mana: {name:'Mana Cost', text:'', y:1729/2814, width:0.9292, height:71/2100, oneLine:true, size:71/1638, align:'right', shadowX:-0.001, shadowY:0.0029, manaCost:true, manaSpacing:0},
		title: {name:'Title', text:'', x:145/2010, y:1702/2814, width:0.8292, height:0.0543, oneLine:true, font:'Magic-Fomalhaut', size:0.0381, color:'white'},
