...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadTextOptions({
		...
		mana2: {name:'Mana Cost 2', text:'', y:0.6886, width:0.9292, height:71/2100, oneLine:true, size:71/1638, align:'right', shadowX:-0.001, shadowY:0.0029, manaCost:true, manaSpacing:0, rotation:180}, // Updated to match mana properties
