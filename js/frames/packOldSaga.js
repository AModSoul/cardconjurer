...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadTextOptions({
		...
		ability0: {name:'Ability 1', text:'', x:0.1447, y:0.2896, width:0.32, height:0.1786, size:0.0305, ...card.text.ability0},
		ability1: {name:'Ability 2', text:'', x:0.1447, y:0, width:0.32, height:0.1786, size:0.0305, ...card.text.ability1},
		ability2: {name:'Ability 3', text:'', x:0.1447, y:0, width:0.32, height:0.1786, size:0.0305, ...card.text.ability2},
		ability3: {name:'Ability 4', text:'', x:0.1447, y:0, width:0.32, height:0, size:0.0305, ...card.text.ability3},
		reminder: {name:'Reminder Text', text:'{i}(As this Saga enters and after your draw step, add a lore counter. Sacrifice after III.)', x:0.1, y:0.1043, width:0.3667, height:0.1772, size:0.0281, shadowColor:'white', ...card.text.reminder},
	});
	//bottom info
	loadBottomInfo({
