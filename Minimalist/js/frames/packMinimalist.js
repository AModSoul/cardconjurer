// filepath: c:\Users\Brandon\Documents\GitHub\cardconjurerjosh\js\frames\packMinimalist.js
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadTextOptions({
		...
		title: {name:'Title', text:'', x:0.14, y:0.1200, width:0.768, height:0.0243, oneLine:true, outlineWidth:0.0065, font:'mplantin', size:0.0229, color:'white', align:'right'},
		...
		rules: {name:'Rules Text', text:'', x:0.086, y:0.1, width:0.771, height:0.15, size:0.033, outlineWidth:0.008, font:'Plantin MT Pro', color:'white', minHeight: 0.15, maxHeight: 0.4},
